...
public class MotorFixed {
	...
	protected final GpioPinDigitalOutput trigPinForward;
	protected final GpioPinDigitalOutput trigPinBackward;
	protected boolean forwardOn = false;
	protected boolean backwardOn = false;
